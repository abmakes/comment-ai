      ...
      <main className="flex flex-col justify-between items-center w-full h-screen overflow-clip">
          ...
          <div className="container px-0 flex flex-col items-center h-full w-full max-w-4xl justify-center"> 
            ...
            <div className="flex flex-wrap w-full justify-between">
              <Image className="animate__animated animate__fadeInLeft animate__delay-2s a self-start w-72 md:w-96" src="/speech-cindy.png" width={403} height={283} alt="student comment"></Image>
          ...
          {
            !userId && !isLoaded && 
            <svg className="stroke-gray-700 w-full h-8 mt-24" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke-linecap="round" stroke-width="2"><path stroke-dasharray="60" stroke-dashoffset="60" stroke-opacity=".3" d="M12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="1.3s" values="60;0"/></path><path stroke-dasharray="15" stroke-dashoffset="15" d="M12 3C16.9706 3 21 7.02944 21 12"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.3s" values="15;0"/><animateTransform attributeName="transform" dur="1.5s" repeatCount="indefinite" type="rotate" values="0 12 12;360 12 12"/></path></g></svg>
          }
                  ...
                  <div className="flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div className="sm:block sm:ml-6">
                      <div className="flex space-x-4 px-3 text-gray-600 text-sm font-medium">
                        <div className="hidden hover:text-violet-600 hover:fill-violet-600 hover:border-violet-400 hover:bg-violet-50 hover:shadow text-gray-600 fill-gray-600  border rounded-full font-semibold h-7 px-3 flex gap-2 items-center cursor-pointer">
